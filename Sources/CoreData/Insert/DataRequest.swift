...
public extension DataResponseSerializer {
    ...
    init<ParentValue>(
		...
		transformer: @escaping (ResponseInfo, Swift.Result<ParentValue, Error>) -> Result<Value>
    ) {
		self.init { request, response, data, error -> Result<Value> in
			switch parent.serializeResponse(request, response, data, error) {
...
public extension DataRequest {
    ...
    static func jsonTransformerSerializer(
        ...
        transformer: @escaping ((ResponseInfo, Swift.Result<Any, Error>) -> Result<Any>)
